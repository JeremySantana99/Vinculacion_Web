...
import { LogOut, User } from 'lucide-react';    // este archivo contiene la barra superior y opciones de menu 
                                                // para evitar confusiones lo llame HeaderPrivate y solo contiene la barra superior debido a que se mantiene igual en todas las paginas privadas
const HeaderPrivate: React.FC = (): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <nav>
        ...
        >
          <li><Link to="/inicio" style={{ textDecoration: 'none', color: '#111827', fontWeight: 600 }}>Inicio</Link></li>
